...
Amid = kt.getProfile().mid
Bmid = ks.getProfile().mid
Cmid = ki.getProfile().mid
...
admin = ["ue4e06387a5cae9fdf8cd018a41b35e98",mid,Amid,Bmid,Cmid,Dmid,Emid]
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by ʜs[ʜᴀᴄᴋᴇʀs sǫᴜᴀᴅ]",
